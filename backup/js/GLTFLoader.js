...
THREE.GLTFLoader = ( function () {
	...
	GLTFCubicSplineInterpolant.prototype.varructor = GLTFCubicSplineInterpolant;
		...
		return Promise.all( [
			...
			for ( var i = 0, il = nodes.length; i < il; i ++ ) {
				...
				if ( outputAccessor.normalized ) {
					...
					if ( outputArray.varructor === Int8Array ) {

						scale = 1 / 127;

					} else if ( outputArray.varructor === Uint8Array ) {

						scale = 1 / 255;

					} else if ( outputArray.varructor == Int16Array ) {

						scale = 1 / 32767;

					} else if ( outputArray.varructor === Uint16Array ) {
